...
builder.queryType({
  fields: t => ({
    hello: t.string({
      resolve: () => 'Hello Mother Fucker!',
    }),
  }),
});

// Define Mutation type with at least one mutation field
// builder.mutationType({
//   fields: t => ({
//     createExample: t.field({
//       type: 'String', // Replace this with your desired return type
//       args: {
//         data: t.arg({ type: 'String', required: true }), // Example argument
//       },
//       resolve: async (parent, { data }) => {
//         // Example mutation logic, replace with your actual logic
